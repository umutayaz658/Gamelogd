 ...
 * data by `activeBoard` (Kanban, GDD Hub, Asset Registry, Team & Roles).
 * Self-contained: reads useWorkspace()/useAuth() directly, no props needed.
 */
export default function BoardSwitcher() {
    ...
    }, [activeBoard, activeWorkspace, projects, user]);
