...
interface GameDNAProps {
    ...
    username?: string;
    // When false, renders only the bar list (no card wrapper/own header) — used by the
    // mobile accordion, which supplies its own single header instead of stacking a second
    // "Game DNA" title underneath.
    showHeader?: boolean;
}
