...
import { Gamepad2, ArrowLeft, ChevronLeft, ChevronRight, ListTodo, Users, TrendingUp, Sparkles, RefreshCw } from 'lucide-react';
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            try {
                ...
                const [backlogRes, friendsRes, trendingRes] = await Promise.all([
