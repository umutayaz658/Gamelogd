    ...
    return (
        <div className="min-h-screen bg-zinc-950 text-white font-sans selection:bg-blue-500/30">
                            ...
                            <div className="px-6 pb-6 pt-0 relative flex flex-col md:flex-row md:items-end justify-between gap-6">
                                ...
                                <div className="flex items-center gap-3 self-start md:self-end">
                                    <button
                                        ...
                                        className="flex items-center justify-center p-2.5 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 hover:border-zinc-700 text-zinc-300 hover:text-white rounded-xl transition-all"
                                    >
            ...
            <ShareCardModal
                ...
                entityId={organisation.slug}
                shareTitle={organisation.name}
                shareText={organisation.description?.slice(0, 100)}
            />
        </div>
    );
}
