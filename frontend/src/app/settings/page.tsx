...
const translations = {
    English: {
        ...
        allowDmsDesc: "When off, everyone's messages (even people you follow) arrive as a request you must accept first. When on, only messages from people who don't follow you arrive as requests.",
    ...
    Turkish: {
        ...
        allowDmsDesc: "Kapalıyken herkesin mesajı (takip ettikleriniz dahil) önce kabul etmeniz gereken bir istek olarak gelir. Açıkken sadece sizi takip etmeyenlerin mesajları istek olarak gelir.",
    ...
    Spanish: {
        ...
        allowDmsDesc: "Cuando está desactivado, todos los mensajes (incluso de personas que sigues) llegan como una solicitud que debes aceptar primero. Cuando está activado, solo los mensajes de quienes no te siguen llegan como solicitudes.",
    ...
    French: {
        ...
        allowDmsDesc: "Lorsque désactivé, tous les messages (même de personnes que vous suivez) arrivent comme une demande que vous devez d'abord accepter. Lorsqu'activé, seuls les messages de ceux qui ne vous suivent pas arrivent comme des demandes.",
    ...
    German: {
        ...
        allowDmsDesc: "Wenn deaktiviert, kommen alle Nachrichten (auch von Personen, denen du folgst) als Anfrage an, die du zuerst annehmen musst. Wenn aktiviert, kommen nur Nachrichten von Personen, die dir nicht folgen, als Anfrage an.",
