    ...
    useEffect(() => {
        const fetchGame = async () => {
            try {
                ...
                // The Server Component wrapper (page.tsx) already resolved this game to a
                // real one via notFound() before rendering us — a failure here is a
                // transient client-side hiccup, not evidence the game doesn't exist.
                        ...
                        <div className="flex-1 mt-auto pt-4 md:pb-4 text-white z-20">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-4">
                                ...
                                <div className="flex items-center gap-3 w-full sm:w-auto">
                                    <button
                                        onClick={() => { if (requireAuth('logGame')) return; openLogModal(game, myReview); }}
